...
namespace HerhangiOT.GameServerLibrary.Model
{
    public class Player : Creature
    {
        ...
        public uint BaseSpeed { get; private set; }
        ...
        public Player(Connection connection, string accountName, string characterName)
        {
        ...
        public bool PreloadPlayer()
        {
            ...
            AccountType = (AccountTypes)account.AccounType;
        ...
        public bool LoadPlayer()
        {
            ...
            ulong nextMagicLevelMana = VocationData.GetManaReq(CharacterData.MagicLevel + 1);
            ...
            SkillPercents = new byte[(byte)GameServerLibrary.Skills.Last + 1];
            SkillPercents[(byte)GameServerLibrary.Skills.Fist] = GetPercentage(CharacterData.SkillFistTries, VocationData.GetSkillReq(GameServerLibrary.Skills.Fist, CharacterData.SkillFist + 1U));
            SkillPercents[(byte)GameServerLibrary.Skills.Club] = GetPercentage(CharacterData.SkillClubTries, VocationData.GetSkillReq(GameServerLibrary.Skills.Club, CharacterData.SkillClub + 1U));
            SkillPercents[(byte)GameServerLibrary.Skills.Sword] = GetPercentage(CharacterData.SkillSwordTries, VocationData.GetSkillReq(GameServerLibrary.Skills.Sword, CharacterData.SkillSword + 1U));
            SkillPercents[(byte)GameServerLibrary.Skills.Axe] = GetPercentage(CharacterData.SkillAxeTries, VocationData.GetSkillReq(GameServerLibrary.Skills.Axe, CharacterData.SkillAxe + 1U));
            SkillPercents[(byte)GameServerLibrary.Skills.Distance] = GetPercentage(CharacterData.SkillDistanceTries, VocationData.GetSkillReq(GameServerLibrary.Skills.Distance, CharacterData.SkillDistance + 1U));
            SkillPercents[(byte)GameServerLibrary.Skills.Shield] = GetPercentage(CharacterData.SkillShieldingTries, VocationData.GetSkillReq(GameServerLibrary.Skills.Shield, CharacterData.SkillShielding + 1U));
            SkillPercents[(byte)GameServerLibrary.Skills.Fishing] = GetPercentage(CharacterData.SkillFishingTries, VocationData.GetSkillReq(GameServerLibrary.Skills.Fishing, CharacterData.SkillFishing + 1U));
        ...
        private void UpdateBaseSpeed()
        {
            ...
            //{
                BaseSpeed = VocationData.BaseSpeed + (2U * (CharacterData.Level - 1U));
            //}
            //else
            //{
