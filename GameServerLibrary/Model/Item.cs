using System;
using System.IO;
using HerhangiOT.GameServerLibrary.Model.Items;
...
namespace HerhangiOT.GameServerLibrary.Model
{
    public class Item : Thing
    {
        ...
        public Item(ushort id, byte count = 0)
        {
            ...
            if (it.Group.HasFlag(ItemGroup.Fluid) || it.Group.HasFlag(ItemGroup.Splash))
            {
        ...
        public static Item CreateItem(ushort itemId, byte count = 0)
        {
            ...
            if (it.Group == ItemGroup.Deprecated)
                return null;
	        ...
	        if (it.Id != 0) {
		        ...
		        } else if (it.Group.HasFlag(ItemGroup.Container)) {
